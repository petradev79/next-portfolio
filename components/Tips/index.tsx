      ...
      <div className={styles['tips-container']}>
        ...
        <div className={styles.tip}>
          ...
          <h3>
            ...
            <span>teamwork and collaboration skills</span> are good for business
          </h3>
          <p>
            Collaboration is key for{' '}
            <span>
              delivering better products and services to customers and improving
              performance for the company
            </span>{' '}
            and it doesn't necessarily mean less effort, but the quality of the
            work — ideas, solutions, execution — tends to be better.
          </p>
          <p>
            Another important reason to collaborate is for the{' '}
            <span>people involved</span>. Effective collaboration is energizing,
            rewarding, and empowering for employees. Team members can learn hard
            skills and gain relevant insights and tacit knowledge by
            collaborating with others from different and diverse backgrounds.
          </p>
        </div>
        <div className={styles.tip}>
          <h3>
            3. Someone wiser than me said{' '}
            <span>people ignore design that ignores people</span>
          </h3>
          <p>
            Web applications are all about user interaction, so having a clean,
            visually pleasing interface that supports an intuitive user journey
            is essential in creating customer delight.
          </p>
          <ul>
            <li>
              <span>Get to know your users </span>- you won't be able to create
              a product that exceeds users expectations without first
              understanding their preferences and desires.
            </li>
            <li>
              <span>Keep it simple </span>- users appreciate a clean interface
              and intuitive user journey that allows them to navigate with ease.
            </li>
            <li>
        ...
        <div className={styles.tip}>
          <h3>
            4. <span>Learning and improving knowledge</span> is essential to our
            existence
          </h3>
          <p>
            <span>
          ...
          <p>
            ...
            competencies. Continuous learning helps to innovate new ideas. This
